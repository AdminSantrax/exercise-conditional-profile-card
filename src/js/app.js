      ...
      <ul class="${variables.socialMediaPosition}">
        <li>
          <a href="https://twitter.com/4geeksacademy">
            ${variables.twitter || ""}<i class="fab fa-twitter"></i>
          </a>
        </li>
        <li>
          <a href="https://github.com/4geeksacademy">
            ${variables.github || ""}<i class="fab fa-github"></i>
          </a>
        </li>
        <li>
          <a href="https://linkedin.com/school/4geeksacademy">
            ${variables.linkedin || ""}<i class="fab fa-linkedin"></i>
          </a>
        </li>
        <li>
          <a href="https://instagram.com/4geeksacademy">
            ${variables.instagram || ""}<i class="fab fa-instagram"></i>
          </a>
        </li>
      </ul>
    </div>
